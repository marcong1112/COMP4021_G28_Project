...
const ChatPanel = (function() {
    ...
    const initialize = function() {
        function TimeoutType() {
            typing=false;
            Socket.emit('typing', {user: Authentication.getUser(), typing: false});
        }
        ...
        //     Socket.emit('typing', {user: Authentication.getUser(), typing: true});
        //     clearTimeout(timeout);
        //     timeout = setTimeout(TimeoutType, 3000);
        // });
